      ...
      >
        <div className="container mx-auto px-4 py-8">
          ...
          <p className="mb-2">
            ...
            artificial intelligence (AI). <strong>MyCards.study</strong> does not
            guarantee the accuracy, reliability, or appropriateness of the AI-generated
            content. Users acknowledge that by using the service, they may encounter
            content that could be incorrect, misleading, or offensive.{' '}
            <strong>MyCards.study</strong> disclaims all liability related to the use of
            or reliance on any AI-generated content posted on{' '}
          ...
          <p className="mb-2">
            ...
            <strong>MyCards.study</strong> reserves the right to remove such content and
            take appropriate actions against the responsible users, which may include
            reporting to law enforcement authorities and banning from the service.
          </p>

          <h2 className="text-2xl font-semibold mt-6 mb-2">Misleading Information</h2>
          <p className="mb-2">
            <strong>MyCards.study</strong> is not responsible for any misleading or
            incorrect information generated by AI on <strong>mycards.study</strong>. Users
            should exercise caution and use their judgment when interacting with
          ...
          <p className="mb-2">
            ...
            it to us immediately at <strong>{CONTACT_EMAIL}</strong>.{' '}
            <strong>MyCards.study</strong> is committed to maintaining a safe and
            respectful community and appreciates your cooperation in upholding these
            standards.
          </p>

          <h2 className="text-2xl font-semibold mt-6 mb-2">Changes to Terms of Use</h2>
          <p className="mb-2">
            <strong>MyCards.study</strong> reserves the right to modify these Terms of Use
          ...
          {CONTACT_EMAIL && (
            <div>
              ...
              <p className="mb-2">
                ...
                us at <strong>{CONTACT_EMAIL}</strong>.
              </p>
            </div>
          )}
